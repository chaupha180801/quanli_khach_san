...
//        listKHNormal=KHDAO.queryAllKHNormal();
    ...
    private void paintKM(ArrayList<KhuyenMai> list)
    {
        for(KhuyenMai p:list)
        {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnTKNC, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
    ...
    private void btnXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXActionPerformed
        ...
        if(listIsSelected.isEmpty())
            ...
            if(result==JOptionPane.YES_OPTION) {
                KHDAO.remove(listIsSelected.get(0));
                listIsSelected.removeAll(listIsSelected);
                reset();
            }
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(!matches1.isEmpty())
        {
            ...
            pos=1.0*listKM.indexOf(matches1.get(0))/(listKM.size());
